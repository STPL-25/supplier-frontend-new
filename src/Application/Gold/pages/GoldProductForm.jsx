...
const RateTypeModal = ({ isOpen, onClose, onSelect, currentRateType, currentFixRate, currentUnfixRate,formData,setFormData }) => {
  const [selectedRate, setSelectedRate] = useState(currentRateType || "unfix");
  // const [fixRateValue, setFixRateValue] = useState(currentFixRate || "");
  // const [unfixRateValue, setUnfixRateValue] = useState(currentUnfixRate || "");
  ...
  //     setFormData((prev) => ({
  //       ...prev,
  //       rateFixType: currentRateType || "unfix",
  //       rate: currentRateType === "fix" ? currentFixRate || "" : currentUnfixRate || "",
  //     }));
  //     setError("");
  //   }
  // }, [isOpen, currentRateType, currentFixRate, currentUnfixRate]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-3">
      ...
      <RateTypeModal
        ...
        onSelect={handleRateTypeSelect}
        currentRateType={formData.rateFixType || "unfix"}
        currentFixRate={formData.fixRate || ""}
        currentUnfixRate={formData.unfixRate || ""}
        formData={formData}
        setFormData={setFormData}
      />
