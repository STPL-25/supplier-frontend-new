...
// //     // Only fetch if supplierId exists and is valid
...
// //       // Auto-populate supplier details from API response
// //       if (response.data) {
...
// //         // Also update search query with supplier name
// //         // setSearchQuery(supplierData.companyname || "");
// //       }
// //     } catch (error) {
...
// //             from: {
// //               ...companyData,
// //               // Preserve the parentCompany selection if it exists
...
// //       if (
// //         (field === "purchaseIncharge" || field === "purchaseManager") &&
// //         (!value || value.trim() === "")
// //       ) {
// //         return `${
...
// //       // Validate parent company selection for TCT
...
// //     // Update the parentCompany key in from
// //     handleInputChange("from", "parentCompany", selectedParentKey, "1");
    
// //     // Also update the parentCompany object with the selected preset data
...
// //       // Clear parent company error when selected
...
// //             {/* Parent Company Selection - Only show for TCT */}
...
// //                   </p>
// //                 )}
// //                 {/* Show selected parent company preview */}
...
//                             name="paymentType"
//                             value="Labour Bill"
//                             checked={formData.delivery.paymentType === "Labour Bill"}
//                             onChange={(e) =>
//                               handleInputChange(
//                                 "delivery",
//                                 "paymentType",
