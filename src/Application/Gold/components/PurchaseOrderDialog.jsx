...
const PurchaseOrderDialog = ({
  ...
  useEffect(() => {
    if (
      ...
      setFormData((prev) => ({
        ...prev,
        delivery: { ...prev.delivery, paymentType: "RSB" },
      }));
    }
      ...
      if (selectedParentPreset) {
        setFormData((prev) => ({
          ...
          parentCompany: {
            ...
            poPreFix: selectedParentPreset.poPreFix || "",
          },
        }));
...
console.log(formData)
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
              ...
              <div className="space-y-4">
                {regularFields.slice(0, 4).map((field) => (
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <div>
      ...
      <div className="space-y-4">
        {regularFields.slice(0, 3).map((field) => (  // Changed from 4 to 3
          <FormInput
            key={`${field.section}.${field.field}`}
            label={field.label}
            type={field.type}
    ...
    <div>
      ...
      <div className="space-y-4">
        {regularFields.slice(3).map((field) => (  // Changed from slice(2) to slice(3)
          <FormInput
            key={`${field.section}.${field.field}`}
            label={field.label}
            type={field.type}
